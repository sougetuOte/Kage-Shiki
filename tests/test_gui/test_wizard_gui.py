...
class TestWizardStepMethodSelect:
    ...
    def test_initial_step_is_method_select(self, tk_root, tmp_path):
    ...
    def test_method_a_button_transitions_to_input_a(self, tk_root, tmp_path):
    ...
    def test_method_b_button_transitions_to_input_b(self, tk_root, tmp_path):
    ...
    def test_method_c_button_transitions_to_input_c(self, tk_root, tmp_path):
...
class TestWizardInputScreens:
    ...
    def test_input_a_back_returns_to_method_select(self, tk_root, tmp_path):
    ...
    def test_input_b_back_returns_to_method_select(self, tk_root, tmp_path):
    ...
    def test_input_c_back_returns_to_method_select(self, tk_root, tmp_path):
    ...
    def test_method_c_submit_goes_to_preview(self, tk_root, tmp_path):
...
class TestWizardPreview:
    ...
    def test_preview_shows_persona_name(self, tk_root, tmp_path):
    ...
    def test_preview_retry_returns_to_method_select(self, tk_root, tmp_path):
    ...
    def test_preview_send_displays_response(self, tk_root, tmp_path):
        """送信後にセリフが表示エリアに反映される."""
        ctrl = _make_mock_wizard_ctrl()
        gui = WizardGUI(
            tk_root, ctrl, PersonaSystem(), tmp_path, _make_config(),
    ...
    def test_preview_confirm_transitions_to_freeze(self, tk_root, tmp_path):
...
class TestWizardFreeze:
    ...
    def test_freeze_cancel_returns_to_method_select(self, tk_root, tmp_path):
...
class TestProcessingGuard:
    ...
    def test_is_processing_blocks_preview_send(self, tk_root, tmp_path):
